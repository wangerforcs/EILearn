...
最后这几天团队确实也在忙(xvla/smolvla)，但是忙的结果并不好，最后也没有很明显的提升，凑出来一版交了；我这边想放弃lerobot，loss大训的慢，而且长期了解到openpi的pi05 jax checkpoint微调比pytorch更好，我就换到了jax，数据集是扩充过的，补充了部分seen/unseen的数据，平均大概每种400 episodes，但是来不及了也没有训完，最后测试并不好。
